...
//     >
//       <div className={`relative bg-gradient-to-br ${service.color} p-1 rounded-3xl shadow-xl`}>
...
//                     <motion.div
//                       key={idx}
//                       className="flex items-center bg-[#F6FFFA] rounded-lg py-2 px-3 shadow-sm"
//                       initial={{ x: -12, opacity: 0 }}
//                       animate={{ x: 0, opacity: 1 }}
//                       transition={{ delay: 0.15 + idx * 0.07 }}
//                     >
//                       <div className="w-8 h-8 mr-3 flex items-center justify-center bg-white rounded-md border border-gray-100 shadow">
//                         <img src={item.logo} alt={`${item.name} logo`} className="max-w-full max-h-full object-contain" />
//                       </div>
