...
//       whileHover={{ scale: 1.02 }}
//     >
//       <div className="bg-[#FAFAFA] p-6 rounded-xl shadow-sm border border-gray-100">
...
//                     transition={{ delay: 0.1 + idx * 0.05 }}
//                   >
//                     <div className="w-8 h-8 mr-3 flex items-center justify-center bg-white border border-gray-200 rounded-md p-1">
